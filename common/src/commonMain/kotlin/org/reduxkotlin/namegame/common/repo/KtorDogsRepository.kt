...
import org.reduxkotlin.namegame.common.util.profile
...
import org.reduxkotlin.namegame.common.repo.GatewayResponse
import org.reduxkotlin.namegame.common.repo.GenericError
...
open class KtorDogsRepository(private val networkContext: CoroutineContext) : CoroutineScope {
    ...
    suspend fun dogs(): GatewayResponse<List<Dog>, GenericError> {
        return try {
                                ...
                                async {
                                    val dogImageResponse =
                                            try {
                                                ...
                                                org.reduxkotlin.namegame.common.util.Logger.d("Failure fetching image: ${e.message}")
                                                GatewayResponse.createSuccess<DogImageResponse, GenericError>(DogImageResponse("200", ""), 200, "")
                                            }
            ...
            org.reduxkotlin.namegame.common.util.Logger.d("Failure fetching dogs: $e")
            org.reduxkotlin.namegame.common.util.Logger.d("Failure fetching dogs: ${e::class.qualifiedName}")
...
//        } catch (e: Exception) {
//            org.reduxkotlin.namegame.common.util.Logger.d("Failure fetching breed image: ${e.message}")
//            GatewayResponse.createError(GenericError(e.message
//                    ?: "Failure"), 500, e.message ?: "failure")
//        }
    }
...
//        return try {
        ...
        return GatewayResponse.createSuccess(response, 200, "Success")
//        } catch (e: Exception) {
//            org.reduxkotlin.namegame.common.util.Logger.d("Failure fetching subbreed image: ${e.message}")
//            GatewayResponse.createError(GenericError(e.message
//                    ?: "Failure"), 500, e.message ?: "failure")
//        }
    }
